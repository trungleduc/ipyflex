...
# -*- coding: utf-8 -*-
#
# ipyflex documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipyflex', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'ipyflex.tex', 'ipyflex Documentation',
     'Trung Le', 'manual'),
]
